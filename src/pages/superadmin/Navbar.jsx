      ...
      <nav className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
        <div className="hs-accordion-group pb-0 px-2 w-full flex flex-col flex-wrap h-full" data-hs-accordion-always-open>
          <ul className="space-y-1 flex-1">
            ...
            <li>
              <a className={`w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg transition-all duration-300 ease-in-out ${window.location.pathname === '/superadmin/users' ? 'bg-gray-100 text-gray-800' : 'text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100'}`} href="/superadmin/users">
            ...
            <li>
              <a className={`w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg transition-all duration-300 ease-in-out ${window.location.pathname === '/superadmin/announcements' ? 'bg-gray-100 text-gray-800' : 'text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100'}`} href="/superadmin/announcements">
            ...
            <li>
              <a className={`w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg transition-all duration-300 ease-in-out ${window.location.pathname === '/superadmin/settings' ? 'bg-gray-100 text-gray-800' : 'text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100'}`} href="/superadmin/settings">
          ...
          <div className="flex-1 flex flex-col justify-end">
            <ul>
              <li>
                <a onClick={handleLogout} className="w-full flex items-center gap-x-3.5 py-2 my-3 px-2.5 text-sm text-red-500 rounded-lg hover:cursor-pointer hover:bg-red-50 focus:outline-hidden focus:bg-gray-100 transition-all duration-300 ease-in-out" >
                  ...
                  <span className="pl-2 pr-2">Logout</span>
                </a>
              </li>
            </ul>
          </div>
